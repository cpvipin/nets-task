package eu.nets.portal.training.util;
...
public final class DateUtils {
	...
	public  static Date subtractMillisecondsFromDate(Date aDate,int millis)
	{
		Calendar cal = Calendar.getInstance();
		cal.setTime(aDate);
	...
	public  static Date addMillisecondsFromDate(Date aDate,int millis)
	{
		Calendar cal = Calendar.getInstance();
		cal.setTime(aDate);
		cal.add(Calendar.MILLISECOND, millis);
